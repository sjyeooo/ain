...
void WalletInit::AddWalletOptions() const
{
    ...
    gArgs.AddArg("-walletbackup=<h>", strprintf("Backup wallet database every <h> hour(s) (default: %d), to disable <= 0", DEFAULT_WALLET_BACKUP_HOURS), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
}
